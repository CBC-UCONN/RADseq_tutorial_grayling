...
# above we used "base" R functions. 
# a set of packages collectively called the "tidyverse"
# implements alternative ways of manipulating data
# to make it amenable to analysis and visualization
# we'll use a few idioms from that language to reformat data

library(tidyverse)

# an R equivalent to the linux pipe
